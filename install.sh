...
cd / && sudo apt full-upgrade && sudo apt install git pipx gcc libcap-dev python-dev && sudo git clone https://github.com/sp29174/GreenhousePython.git && sudo pipx ensurepath && sudo reboot
